...
export async function load ({params}) {
    ...
    let temp = await getSheets("1Is6nuVcggWi0hPImTRVcORYuGLffcHvM9rd8r6TbWZE", ranges)
    let headers = temp[1]
    ...
    teamsIndy = teamsIndy.filter(player => player[0] && player[4] == 'Free Agent' && player[playerPlayingH] === 'FALSE')
